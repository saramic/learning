...
;; Gets the current tuurn owener (white or black)
...
;; We crown balck pieces in row 0, white pices in row 7
...
;; Converts a piece into a croned piece and invokes
;; a host notifier
...
(func $initBoard
  ...
  ;; (export "whiteCrown" (func $withCrown))
