...
class CalculatorTest < Hanami::Minitest::RequestTest
  ...
  test "calculates the speed of light from valid measurements" do
    post "/calculator", frequency_mhz: "2450", spot_distance_cm: "18.3", gap_count: "3"
  ...
  test "shows an error message for invalid measurements" do
    post "/calculator", frequency_mhz: "abc", spot_distance_cm: "xyz", gap_count: "1"
